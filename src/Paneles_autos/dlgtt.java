...
public class dlgtt extends javax.swing.JDialog {

    /**
     * Creates new form dlgtt
     */
    public dlgtt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgtt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgtt dialog = new dlgtt(new javax.swing.JFrame(), true);
